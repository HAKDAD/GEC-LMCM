...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://sql10658780:KhjR5Biwz1@sql10.freesqldatabase.com/sql10658780'
...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://admin12122:vamsi123@admin12122.mysql.pythonanywhere-services.com/admin12122$GEC'
            ...
            if teacher:
                ...
                if class_data:
                    ...
                    if not class_notification and not leave_request:
                        ...
                        # Send a reminder to the assigned teacher
...
def edit_class(class_id):
    ...
    if request.method == 'POST':
        try:
            ...
            db.session.rollback()
            flash(f"Error updating class details: {str(e)}")
